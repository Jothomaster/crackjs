...
btn.addEventListener('click', async () => {
  const data = await window.files.showPicker()
  filePathElement.innerText = data

  bigData = data.map(x => BigInt(x))
...
function encrypt(data) {
  ...
  // do{
  //     pub = getRandNum(2, n-1);
  // }while(egcd(n, pub)[0] != 1);
...
console.log(qpow(477702998n, 1141753273n, 2820832543n))
